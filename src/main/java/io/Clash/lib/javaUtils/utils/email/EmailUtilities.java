package io.Clash.lib.javaUtils.utils.email;

import io.Clash.lib.javaUtils.collections.Pair;
import io.Clash.lib.javaUtils.context.ContextStore;
import jakarta.mail.*;
import jakarta.mail.internet.*;
import io.Clash.lib.javaUtils.utils.DateUtilities;
import io.Clash.lib.javaUtils.utils.Printer;
import io.Clash.lib.javaUtils.utils.StringUtilities;
import io.Clash.lib.javaUtils.utils.email.mapping.EmailFlag;
import io.Clash.lib.javaUtils.utils.reflection.ReflectionUtilities;
...
import static io.Clash.lib.javaUtils.utils.StringUtilities.markup;
import static io.Clash.lib.javaUtils.utils.arrays.lambda.Collectors.toSingleton;
...
public class EmailUtilities {
    ...
    public static class Inbox {
        ...
        public void load(int timeout, int expectedMessageCount, boolean print, boolean save, boolean saveAttachments, List<Pair<EmailField, String>> filterPairs) {
            Inbox.load(this, timeout, expectedMessageCount, print, save, saveAttachments, filterPairs);
        }
        ...
        public static void clearInbox(String email, String emailApplicationPassword, String host, String port, String secureCon) {
            ...
            Inbox inbox = new Inbox(host, port, email, emailApplicationPassword, secureCon, EmailProtocol.IMAP);
            inbox.clearInbox();
        }
