...
public enum RedirectOperator {
    INPUT("<"), INPUT_DUPLICATE("<&"), INPUT_CLOSE("<&-"),
    HEREDOC("<<"), HEREDOC_STRIP_TABS("<<-"), HERESTRING("<<<"),
    OUTPUT(">"), OUTPUT_DUPLICATE(">&"), OUTPUT_CLOSE(">&-"),
    OUTPUT_APPEND(">>"), OUTPUT_CLOBBER(">|"),
    STDOUT_STDERR("&>"), STDOUT_STDERR_APPEND("&>>");
